...
const RegisterDeliveryUnit = () => {
  ...
  const handleOnChange = (e) => {
    ...
    const specificAddress = name === 'specificAddress' ? value : prev.storeAddress.split(' ')[0];
...
export default RegisterDeliveryUnit;
